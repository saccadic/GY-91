...
PROGMEM static const unsigned char dmp_memory[DMP_CODE_SIZE] = {
  /* bank # 0 */
...
{
//  unsigned char _dmp_memory[DMP_CODE_SIZE];
//  for (int i = 0; i < sizeof(dmp_memory) / sizeof(*dmp_memory); i++) {
//    _dmp_memory[i] = pgm_read_word(dmp_memory + i);
//  }
